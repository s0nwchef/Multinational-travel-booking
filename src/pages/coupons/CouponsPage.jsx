...
const CouponsPage = () => {
  const coupons = [
    ...
    { id: 2, title: '$50 OFF', subtitle: 'Luxury Tour Packages', description: 'Enjoy a discount on premium tour bookings worldwide.', expires: '2026-11-30', code: 'TOUR50', status: 'ACTIVE', icon: bed },
