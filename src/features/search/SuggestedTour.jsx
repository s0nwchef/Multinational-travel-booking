...
import { toursData } from "../tours/TourList"; // Đảm bảo đường dẫn import đúng

function VerticalCard({ tour }) {
  return (
    <div className="group cursor-pointer">
      {/* Phần Hình Ảnh (Bo góc, có hiệu ứng zoom nhẹ khi hover) */}
...
export default function SuggestedTours() {
  // Lọc chính xác 4 ID (4, 5, 6, 7) tương ứng với Paris, Bali, Tokyo, Rome để giống hệt UI
