...
// High-quality static data moved outside to prevent re-creation on every render
...
// Global destinations for random discovery
...
export default function FavoriteChoices() {
  ...
  const fetchOpenTripMapData = useCallback(async () => {
    ...
    try {
      ...
      // Pick a random city from our global list
      const city = GLOBAL_DESTINATIONS[Math.floor(Math.random() * GLOBAL_DESTINATIONS.length)];
      setCurrentCity(city.name);

      // Step 1: Get a list of interesting places in the selected city
      const radiusUrl = `https://api.opentripmap.com/0.1/en/places/radius?radius=15000&lon=${city.lon}&lat=${city.lat}&format=json&limit=15&apikey=${API_KEY}`;
      ...
      // Step 2: Fetch details for each selected place
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="#" className="text-primary text-sm font-bold hover:text-primary-dark flex items-center gap-1 group">
