...
import { PlaneTakeoff, Menu, Search, Heart, Bell, LogOut, X, ChevronRight } from 'lucide-react';
import { Link, NavLink, useLocation } from 'react-router-dom';
import { motion, AnimatePresence } from 'motion/react';
import HeaderMobile from './HeaderMobile';

export default function Header({ onOpenAuth, onOpenWishlist, onOpenNotifications, isMobileMenuOpen, setIsMobileMenuOpen }) {
              ...
              {navLinks.map((link) => {
                ...
                return (
                    ...
                    >
                      <motion.span
                          animate={{
                            color: isIndicatorActive ? 'var(--color-primary)' : '#6B7280',
            ...
            <div className="flex-1 flex justify-end items-center gap-4">
              ...
              <div className="hidden lg:flex items-center gap-2">
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="p-2 text-primary transition-transform"
                >
