...
const CustomInput = ({ label, icon: Icon, type = "text", placeholder }) => (
            ...
            >
                ...
                <div className="relative z-10 w-full max-w-md mt-10 px-8 flex flex-col items-center">
                    ...
                    <form className="w-full space-y-1" onSubmit={(e) => e.preventDefault()}>
                        {isRegister && (
                            <CustomInput label="Full Name" icon={User} placeholder="John Doe" />
                        )}
                        <CustomInput label="Email Id" icon={Mail} placeholder="wanderer@travel.com" />
                        <CustomInput label="Password" icon={Lock} type="password" placeholder="••••••••••••" />

                        {!isRegister && (
                            <div className="flex justify-end mt-1">
                                <button className="text-[10px] text-orange-500 font-bold hover:underline">
                        ...
                        <div className="flex justify-center mt-6">
                            <button className="bg-[#FF5B00] hover:bg-[#D64D00] text-white font-black py-3 px-14 rounded-xl shadow-[0_10px_20px_rgba(255,91,0,0.3)] transition-all uppercase text-sm tracking-widest">
